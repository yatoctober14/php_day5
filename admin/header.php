<?php 
	require_once('../php/intialize.php');
?>
<!DOCTYPE html>
...
<div class="super_container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-faded navbar-toggleable-md col-12 first-nav"
         style="direction: rtl">
        <a class="navbar-brand col-lg-3 col-md-3 col-sm-3" href="<?php echo at_root()."index.php";?>"><img src="<?php echo at_public()."images/logo.png"?>" class="logo ml-5"></a>
        ...
        <div class="language_nav_item dropdown col-lg-3 col-md-3">
